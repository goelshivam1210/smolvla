...
|-----------|-----------|-------------|
| In-distribution | libero_spatial | _TBD_ |
| OOD — Objects | libero_object | _TBD_ |
| OOD — Goals | libero_goal | _TBD_ |

| Ablation | LoRA Rank | Final Loss | Success Rate |
|----------|-----------|------------|-------------|
| Run 1 (primary) | r=32 | _TBD_ | _TBD_ |
| Run 2 (ablation) | r=8 | _TBD_ | _TBD_ |
